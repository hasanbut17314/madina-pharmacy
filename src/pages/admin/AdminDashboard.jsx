        ...
        <Tabs defaultValue="overview" className="w-full">
              ...
              <Card className="col-span-1">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-xs">
                    Last 6 months of pharmacy revenue
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value="inventory">
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-xs">
                  Control and monitor your pharmacy's stock
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-center py-8 text-xs text-gray-500">
                  Inventory tab content would go here
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="sales">
            <Card>
              ...
              <CardContent>
                <p className="text-center py-8 text-xs text-gray-500">
                  Sales tab content would go here
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="customers">
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-xs">
                  Patient records and customer analytics
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-center py-8 text-xs text-gray-500">
