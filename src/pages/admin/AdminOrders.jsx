...
const orderData = {
  activeOrders: [
    ...
    },
    {
      ...
      products: [
        { name: 'Leather Jacket', price: 45.50, quantity: 1 }
      ],
    ...
    },
    {
      ...
      address: '456 Elm St, Townsburg',
      products: [
        { name: 'Winter Boots', price: 45.50, quantity: 1 }
      ],
      rider: 'Pending Assignment',
      estimatedDelivery: 'March 24'
    },
    {
      ...
      address: '456 Elm St, Townsburg',
      products: [
        { name: 'Denim Jeans', price: 45.50, quantity: 1 }
      ],
      rider: 'Sarah Wilson',
  ...
  deliveredOrders: [
    ...
    },
    {
      ...
      products: [
        { name: 'Notebook', price: 15.99, quantity: 1 }
      ],
      rider: 'Lisa Green',
    ...
    },
    {
      ...
      address: '101 Pine Lane, Hamletville',
      products: [
        { name: 'Water Bottle', price: 15.99, quantity: 1 }
      ],
      rider: 'James Brown',
      deliveredDate: 'March 12'
    },
    {
      ...
      address: '101 Pine Lane, Hamletville',
      products: [
        { name: 'Phone Case', price: 15.99, quantity: 1 }
      ],
      rider: 'Emma White',
      deliveredDate: 'March 12'
    }
...
const AdminOrders = () => {
  ...
  const handleOrderDetails = (orderId) => {
    ...
    const order = orderData.activeOrders.find(order => order.id === orderId) || 
        ...
        <div className="bg-white rounded-lg p-4 max-w-md w-full max-h-[80vh] overflow-y-auto z-10 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-sm font-medium">{selectedOrder.status}</span>
            </div>
